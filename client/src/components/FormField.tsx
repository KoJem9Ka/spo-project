...
import {InputChangeFn, InputFocusFn,} from '../types'
import {isEmpty} from 'lodash'
import dayjs from 'dayjs'
import {join} from '../utils'
import {IconIsCorrect} from '../assets/icons'
  ...
  return (
    <div>
      ...
      `, disabled ? 'bg-formFieldFocus' : 'bg-formField hover:bg-formFieldFocus focus-within:bg-formFieldFocus')}>
        ...
        <input
          className={join('bg-transparent text-16 text-gray90 pt-28 pr-35 pb-8 pl-12', type === 'date' && !isLabelUp && 'text-transparent')}
